...
class SelectComponent(ModeSelectorComponent):
    ...
    def __init__(self, raw_select_buttons, mode_callback, metronome_button, nudge_down_button, nudge_up_button, tap_tempo_button, transport, looper, session, session_matrix): 
